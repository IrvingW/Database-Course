...
drop table if exists level_charge;
...
/* Table: level_charge                                          */
/*==============================================================*/
create table level_charge
(
   level_id             int not null auto_increment,
   pay_for_days         int not null,
   money                int not null,
   primary key (level_id, pay_for_days)
);
...
alter table charge_record add constraint FK_pay_for_level foreign key (level_id, pay_for_days)
      references level_charge (level_id, pay_for_days) on delete restrict on update restrict;
...
alter table level_charge add constraint FK_charge_detail foreign key (level_id)
      references level_detail (level_id) on delete restrict on update restrict;
